...
const HeroSection = () => {
  ...
  return <section className="pt-28 pb-16 md:pt-40 md:pb-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        }} className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 animate-fade-up text-center">
            Get Recognised for Your
            <span className="text-brand-teal block mt-2 text-center">Brand Love</span>
          </h1>
          
          <p style={{
          animationDelay: '200ms'
        }} className="text-xl text-gray-600 mb-8 animate-fade-up text-center">
