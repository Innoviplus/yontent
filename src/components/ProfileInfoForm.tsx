...
export const ProfileInfoForm: React.FC<ProfileInfoFormProps> = ({
  ...
  // Fix: Use getValues to check if birthDate has already been set and saved
  const birthDateIsSet = typeof profileForm.getValues('birthDate') !== 'undefined' && 
