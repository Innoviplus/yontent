...
const MyRewardTransactions = () => {
  ...
  const renderTransaction = (tx: Transaction) => {
    ...
    return <div key={tx.id} className="flex justify-between items-center bg-white rounded-xl p-6 shadow-card">
        <div>
          ...
          {tx.source === 'ADMIN_ADJUSTMENT' && <div className="text-gray-500 text-xs mt-1">Manual adjustment by admin</div>}
        </div>
  ...
  return <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 max-w-2xl">
        ...
        {!loading && transactions.length === 0 && <div className="text-gray-500 text-center mt-10">No transactions found.</div>}
